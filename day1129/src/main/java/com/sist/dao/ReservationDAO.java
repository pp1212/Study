...
public class ReservationDAO {
	...
	public String insertReservation(ReservationVO r) {
		//예약성공하면 예약번호를 반환하기 위해
		String result = null;
		
		try {
			String sql = "insert into reservation(reservation_no,checkin,checkout,phone,total, "
					+ "count_guest,customer_no,room_no,eno) values(?,?,?,?,0,?,?,?,1000)";
