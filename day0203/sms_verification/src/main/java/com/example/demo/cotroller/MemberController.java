...
public class MemberController {
	...
	public String sendNumber(String phone) {
		String num = "1234";
		//4자리 난수 만들어서 (0~9사이의 난수를 4개) 매개변수로 전달받은 전화번호로 난수를 문자 전송하는 기능 구현
		Random r = new Random();
		int a = r.nextInt(10);	//0~9사이의 난수
		int b = r.nextInt(10);	//0~9사이의 난수
		int c = r.nextInt(10);	//0~9사이의 난수
		int d = r.nextInt(10);	//0~9사이의 난수
		num = a+""+b+""+c+""+d;
