	...
	public DeptTest() {
		...
		btn_add.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(re == 1) {
					System.out.println("부서정보 등록에 성공하였습니다.");
					printDept();
				}else {
					System.out.println("부서정보 등록에 실패하였습니다.");
				}
			}});
		...
		btn_update.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(re == 1) {
					System.out.println("부서정보 수정에 성공하였습니다.");
					printDept();
				}else {
					System.out.println("부서정보 수정에 실패하였습니다.");
				}
			}});
		btn_delete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(re == 1) {
					System.out.println("부서정보 삭제에 성공하였습니다.");
					printDept();
				}else {
					System.out.println("부서정보 삭제에 실패하였습니다.");
				}
			}});
